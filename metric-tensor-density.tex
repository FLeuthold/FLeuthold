...
g^{\lambda \cdot  }(0) )]  \\
&= g(0) * \partial_{\mu} [      
(\det(g_{\cdot \lambda}(0) + x^{\sigma} g_{\cdot \lambda , \sigma} + \mathcal{O}(x^2) )      
 * g^{\lambda \cdot  }(0) ]  \\
&= g(0) * \partial_{\mu} [      
	\det(g_{\cdot \lambda}(0)  * g^{\lambda \cdot  }(0)
	+ x^{\sigma} g_{\cdot \lambda , \sigma}  * g^{\lambda \cdot  }(0) 
	+ \mathcal{O}(x^2)       )]  \\
&= g(0) \cdot \partial_{\mu} \left[ \det\left( \mathbbm{1}^{\cdot}{\cdot} + x^{\sigma} g_{\cdot \lambda , \sigma}(0) g^{\lambda \cdot}(0) + \mathcal{O}(x^2) \right) \right] \\
&= g(0) \cdot \partial_{\mu} \left[ 1 + x^{\sigma} \operatorname{tr}\left( g_{\cdot \lambda , \sigma}(0) g^{\lambda \cdot}(0) \right) + \mathcal{O}(x^2) \right] \\
&= g(0) \cdot \left[ \partial_{\mu}(1) + \partial_{\mu}\left( x^{\sigma} \operatorname{tr}\left( g_{\cdot \lambda , \sigma}(0) g^{\lambda \cdot}(0) \right) \right) + \mathcal{O}(x) \right] \\
&= g(0) \cdot \left[ 0 + \delta_\mu^\sigma \operatorname{tr}\left( g_{\cdot \lambda , \sigma}(0) g^{\lambda \cdot}(0) \right) \right] \\
&= g(0) \cdot \operatorname{tr}\left( g_{\cdot \lambda , \mu}(0) g^{\lambda \cdot}(0) \right) \\
&= g(0) \cdot g_{\nu \lambda , \mu}(0) g^{\lambda \nu}(0)
\end{aligned}
\end{equation}
